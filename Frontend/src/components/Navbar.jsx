...
const Navbar = () => {
  ...
  return (
    <div className="pt-4 pb-5 flex justify-between items-center border-b-[2px] border-gray-300 border-solid">
        <Link to="/" className="text-4xl font-semibold">Logo</Link>
        ...
        <button className="btn btn-secondary dropdown-toggle flex justify-center items-center gap-2 !bg-gray-300"type="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul className="dropdown-menu">
          <Link to="/user/my-profile"><button className="dropdown-item" type="button">Profile</button></Link>
          <Link to="/user/my-appointments"><button className="dropdown-item" type="button">My Appointments</button></Link>
