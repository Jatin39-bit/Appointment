      ...
      <div className="container mx-auto px-4">
        ...
        <div className={`${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-center gap-4 w-full md:w-auto mt-4 md:mt-0`}>
          ...
          {loggedIn ? (
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto justify-center items-center">
              <Link 
                to="/user/login"
                className="w-full md:w-auto text-center py-2 px-6 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors duration-300"
              >
                Login
              </Link>
              <Link 
